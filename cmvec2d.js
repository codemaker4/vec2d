 ...
 * @example
 * new Vector2d(1, 1).mag() === Math.sqrt(2)
 * @example
 * let a = new Vector2d(4, 0); // create an X axis
 * let b = new Vector2d(0, 3); // create an Y axis
...
class Vector2d {
    ...
    /**
     * Create a new Vector2d pointing in a random direction and with a given magnitude.
     * @param {number} [magnitude=1] - The magnitude of the new Vector2d. (default = 1)
    ...
    /**
     * Create a new Vector2d pointing in a random direction and with a random magnitude.
     * @param {number} maxMagnitude - The maximum magnitude of the new Vector2d. (default = 1)
     * @returns {Vector2d} The new vector.
     */
    ...
    /**
     * Create a new Vector2d with the x and y components on a random position in a box.
     * 
    ...
    /**
     * Create and return a new Vector2d instance with the same x and y component values.
     * @returns {Vector2d} The copied vector.
     */
    copy() {
     ...
     * @param {Vector2d} other The vector to copy the component values from.
     ...
     * @param {Vector2d} other The vector to add to this vector.
     * @returns {Vector2d} this
     */
    add(other) {
        this.x += other.x;
     ...
     * @param {Vector2d} other The vector to subtract from this vector.
     * @returns {Vector2d} this
     */
    sub(other) {
        this.x -= other.x;
